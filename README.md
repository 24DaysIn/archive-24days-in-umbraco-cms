...
instead, to save the extra bandwidth of going to Adobe's servers.

Any questions regarding these articles or the 24 Days In Umbraco
project in general, can be directed at the `umbraco` email address
on the `24days.in` domain.
